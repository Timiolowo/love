    ...
    <main className="product-page message-page">
      ...
      <section className="dedicated-flow message-dedicated-flow">
        ...
        {!ready ? <div className="form-card large-form">
          ...
          <button className="ai-button" type="button" disabled={message.trim().length < 3 || isRewriting} onClick={suggestWording}>✦ {isRewriting ? "Gemini is rewriting…" : "Help me say this more gently"}</button>
